...
--------
To clone the Marketplace_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/Marketplace_Web_Theme.git
 cd Marketplace_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from Marketplace_Web_Theme directory
